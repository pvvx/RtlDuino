/*
  PadiWebServer.h - Dead simple web-server.
...
#ifndef PadiWEBSERVER_H
#define PadiWEBSERVER_H
...
{
public:
//  PadiWebServer(IPAddress addr, int port = 80);
  PadiWebServer(int port = 80);
  ~PadiWebServer();
