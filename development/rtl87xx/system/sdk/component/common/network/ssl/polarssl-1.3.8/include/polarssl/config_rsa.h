...
extern unsigned int mfl_code_to_length[];
#define SSL_MAX_CONTENT_LEN               mfl_code_to_length[0] // default = 4096 /**< Size of the input / output buffer */
//#define SSL_MAX_CONTENT_LEN                (4096*3) //4096 /**< Size of the input / output buffer */
