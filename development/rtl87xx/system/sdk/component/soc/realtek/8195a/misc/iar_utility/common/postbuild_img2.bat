...
for /f %%i in ('cmd /c "%tooldir%\readelf -S %cfgdir%/Exe/application.axf | %tooldir%\grep 10006000 | %tooldir%\cut -c 8-10"') do set sectname_img2=%%i
::echo %sectname_img2% rw > tmp.txt
