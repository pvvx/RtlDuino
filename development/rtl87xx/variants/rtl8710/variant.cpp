...
PinDescription g_APinDescription[TOTAL_GPIO_PIN_NUM]=
{
  ...
  {PC_0, NOT_INITIAL, PIO_GPIO                | PIO_PWM, NOT_INITIAL}, //D8  : PWM0, SPI0_CS0, UART0_RX, I2S1_WS, PCM1_SYNC, ETE0
  {PC_1, NOT_INITIAL, PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM, NOT_INITIAL}, //D9  : PWM1, SPI0_CLK, UART0_CTS, I2S1_CLK, PCM1_CLK, ETE1, GPIO_INT 
  {PC_2, NOT_INITIAL, PIO_GPIO                | PIO_PWM, NOT_INITIAL}, //D10 : PWM2, SPI0_MOSI, UART0_RTS, I2S1_SD_TX, PCM1_OUT, ETE2
  {PC_3, NOT_INITIAL, PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM, NOT_INITIAL}, //D11 : PWM3, SPI0_MISO, UART0_TX, I2S1_MCK, PCM1_IN, ETE3, GPIO_INT 
  {PC_4, NOT_INITIAL, PIO_GPIO | PIO_GPIO_IRQ          , NOT_INITIAL}, //D12 : I2C1_SDA, SPI0_CS1, I2S1_SD_RX, GPIO_INT
  {PC_5, NOT_INITIAL, PIO_GPIO | PIO_GPIO_IRQ          , NOT_INITIAL}, //D13 : I2C1_SCL, SPI0_CS2, GPIO_INT
  {PE_0, NOT_INITIAL, PIO_GPIO                | PIO_PWM, NOT_INITIAL}, //D14 : PWM0, JTAG_TRST, UART0_TX, I2C2_SCL, SPI0_CS0, PCM0_SYNC
  {PE_1, NOT_INITIAL, PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM, NOT_INITIAL}, //D15 : PWM1, JTAG_TDI, UART0_RTS, SPI0_CLK, GPIO_INT
  {PE_2, NOT_INITIAL, PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM, NOT_INITIAL}, //D16 : PWM2, JTAG_TDO, UART0_CTS, SPI0_MOSI, GPIO_INT
  {PE_3, NOT_INITIAL, PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM, NOT_INITIAL}, //D17 : PWM3, JTAG_TMS, UART0_RX, SPI0_MISO, GPIO_INT, D_SBY3
  {PE_4, NOT_INITIAL, PIO_GPIO | PIO_GPIO_IRQ          , NOT_INITIAL}, //D18 : JTAG_CLK, SPI0_CS1
};
